...
//  SCLAlertView
//
//  Created by AHMED ALI on 9/26/14.
...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    _labelTitle.textColor = [UIColor colorWithRed: 1.00 green: 0.65 blue: 0.00 alpha: 1.00];//Dark Grey
    _viewText.textColor = [UIColor colorWithRed: 1.00 green: 0.65 blue: 0.00 alpha: 1.00]; //Dark Grey
